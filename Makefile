...
src = $(wildcard ./src/*.cpp ./src/Accelerator/*.cpp ./src/Integrator/*.cpp \
	...
	./src/Scene/Environment/*.cpp ./src/Scene/Camera/*.cpp ./src/Scene/Shape/*.cpp \
	./ext/stb_image/*.cpp ./ext/*.cpp)
...
clean :
	...
	./src/Scene/Environment/*.o ./src/Scene/Camera/*.o ./src/Scene/Shape/*.o \
	./ext/*.o ./ext/stb_image/*.o
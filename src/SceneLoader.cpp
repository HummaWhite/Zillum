...
ScenePtr bidirScene() {
    ...
    scene->addObjectMesh("res/model/bidir/lamp.obj", transform,
        std::make_shared<MetalWorkflow>(std::make_shared<SingleColorSpec>(Spectrum(0.8f, 0.356f, 0.135f)), 1.0f, 0.25f));
    ...
    scene->addObjectMesh("res/model/bidir/shell.obj", transform,
        //std::make_shared<MetalWorkflow>(std::make_shared<SingleColorSpec>(Spectrum(1.0f), 1.0f, 0.014f)
...
ScenePtr boxScene() {
    ...
    scene->addHittable(
        std::make_shared<Object>(
            ...
            //std::make_shared<MetalWorkflow>(std::make_shared<SingleColorSpec>(Spectrum(1.0f), 0.0f, 1.0f)
            std::make_shared<Lambertian>(std::make_shared<SingleColorSpec>(Spectrum(1.0f)))
    ...
    scene->addHittable(
        std::make_shared<Object>(
            std::make_shared<Quad>(
                ...
                Vec3f(-3.0f, 6.0f, -3.0f),
                Vec3f(-3.0f, 0.0f, 3.0f)),
            //std::make_shared<MetalWorkflow>(std::make_shared<SingleColorSpec>(Spectrum(1.0f, 0.25f, 0.25f), 0.0f, 1.0f)
    ...
    scene->addHittable(
        std::make_shared<Object>(
            std::make_shared<Quad>(
                ...
                Vec3f(3.0f, 0.0f, -3.0f),
                Vec3f(3.0f, 6.0f, 3.0f)),
            //std::make_shared<MetalWorkflow>(std::make_shared<SingleColorSpec>(Spectrum(0.25f, 0.25f, 1.0f), 0.0f, 1.0f)
...

    {
        ...
        //     std::make_shared<MetalWorkflow>(std::make_shared<SingleColorSpec>(Spectrum(1.0f, 0.8f, 0.6f), 1.0f, 0.14f)
    ...
    }
    {
        ...
        //     //std::make_shared<MetalWorkflow>(std::make_shared<SingleColorSpec>(Spectrum(1.0f), 1.0f, 0.14f)
        //     //std::make_shared<Dielectric>(Vec3f(1.0f), 0.0f, 0.1f)
        //     std::make_shared<Lambertian>(Spectrum(1.0f))
        // );
    }
    {
        ...
        scene->addObjectMesh(DIR "bunny.obj", std::make_shared<Transform>(model),
            std::make_shared<MetalWorkflow>(std::make_shared<SingleColorSpec>(Spectrum(1.0f, 0.7f, 0.4f)), 1.0f, 0.014f)
            //std::make_shared<Dielectric>(Spectrum(1.0f), 0.0f, 1.5f)
        );
    }
...
ScenePtr cornellBox() {
    ...
    scene->addHittable(
...

     {
        ...
        scene->addObjectMesh("res/model/cube.obj", trBoxLarge,
            //std::make_shared<Lambertian>(std::make_shared<SingleColorSpec>(Spectrum(1.0f)))
            std::make_shared<Mirror>(std::make_shared<SingleColorSpec>(Spectrum(1.0f)))
        );
    }
    ...
    scene->addHittable(
        std::make_shared<Object>(
            std::make_shared<Quad>(
                ...
                Vec3f(-3.0f, 6.0f, -3.0f),
                Vec3f(-3.0f, 0.0f, 3.0f)),
            std::make_shared<MetalWorkflow>(std::make_shared<SingleColorSpec>(Spectrum(1.0f, 0.0f, 0.0f)), 1.0f, roughness)
            ));
    ...
    scene->addHittable(
        std::make_shared<Object>(
            std::make_shared<Quad>(
                ...
                Vec3f(3.0f, 0.0f, -3.0f),
                Vec3f(3.0f, 6.0f, 3.0f)),
            std::make_shared<MetalWorkflow>(std::make_shared<SingleColorSpec>(Spectrum(0.0f, 1.0f, 0.0f)), 1.0f, roughness)
            ));
    ...
    scene->addHittable(
        std::make_shared<Object>(
            std::make_shared<Quad>(
                ...
                Vec3f(3.0f, 3.0f, -3.0f),
                Vec3f(-3.0f, 3.0f, 3.0f)),
            std::make_shared<MetalWorkflow>(std::make_shared<SingleColorSpec>(Spectrum(1.0f)), 1.0f, roughness)
            ));

    scene->addHittable(
        std::make_shared<Object>(
            std::make_shared<Sphere>(Vec3f(1.0f, 1.5f, -2.0f), 1.2f, false),
            std::make_shared<MetalWorkflow>(std::make_shared<SingleColorSpec>(Spectrum(1.0f)), 1.0f, 0.015f)
        ));

    scene->addHittable(
        std::make_shared<Object>(
            std::make_shared<Sphere>(Vec3f(-1.2f, 1.8f, -1.0f), 1.0f, false),
            std::make_shared<MetalWorkflow>(std::make_shared<SingleColorSpec>(Spectrum(0.2f, 0.4f, 1.0f)), 0.0f, 0.12f)
        ));
...
ScenePtr fireplace(bool thin, bool lamp) {
    ...
    scene->addObjectMesh(DIR "metal.obj", transform, std::make_shared<MetalWorkflow>(std::make_shared<SingleColorSpec>(Spectrum(1.0f, 0.7f, 0.4f)), 1.0f, 0.25f));
    scene->addObjectMesh(DIR "mirror.obj", transform, std::make_shared<MetalWorkflow>(std::make_shared<SingleColorSpec>(Spectrum(1.0f)), 1.0f, 0.014f));
...
ScenePtr staircase2()
{
    ...
    scene->addObjectMesh(MOD "Mesh000.obj", transform, std::make_shared<Lambertian>(std::make_shared<SingleColorSpec>(Vec3f(1.0f))));
    ...
    scene->addObjectMesh(MOD "Mesh004.obj", transform, std::make_shared<Lambertian>(std::make_shared<SingleColorSpec>(Vec3f(1.0f))));
    scene->addObjectMesh(MOD "Mesh005.obj", transform, std::make_shared<Lambertian>(std::make_shared<SingleColorSpec>(Vec3f(1.0f))));
    scene->addObjectMesh(MOD "Mesh007.obj", transform, std::make_shared<Lambertian>(std::make_shared<SingleColorSpec>(Vec3f(1.0f))));
    scene->addObjectMesh(MOD "Mesh009.obj", transform, std::make_shared<Lambertian>(std::make_shared<SingleColorSpec>(Vec3f(1.0f))));
    ...
    scene->addObjectMesh(MOD "Mesh012.obj", transform, std::make_shared<Lambertian>(std::make_shared<SingleColorSpec>(Vec3f(1.0f))));
...
ScenePtr setupScene(int windowWidth, int windowHeight)
{
    ...
    //         //std::make_shared<MetalWorkflow>(std::make_shared<SingleColorSpec>(Spectrum(1.0f, 0.5f, 0.2f), 0.0f, 1.0f)

...
Spectrum ThinDielectricBSDF::bsdf(Vec3f wo, Vec3f wi, Vec2f uv, TransportMode mode, Sampler* sampler) const {
    return Spectrum(0.0f);
}

std::optional<BSDFSample> ThinDielectricBSDF::sample(Vec3f wo, Vec2f uv, TransportMode mode, Sampler* sampler) const {

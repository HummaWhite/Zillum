...
float GGXDistrib::d(const glm::vec3 &N, const glm::vec3 &M)
{
    return Microfacet::ggx(glm::dot(N, M), alpha);
}

float GGXDistrib::pdf(const glm::vec3 &N, const glm::vec3 &M, const glm::vec3 &Wo)
{
    if (!visible)
        return d(N, M);
...
glm::vec3 GGXDistrib::sampleWm(const glm::vec3 &N, const glm::vec3 &Wo, const glm::vec2 &u)
{
    if (visible)
    {
...
float GGXDistrib::g(const glm::vec3 &N, const glm::vec3 &Wo, const glm::vec3 &Wi)
{
    return Microfacet::smithG(N, Wo, Wi, alpha);
}

float GTR1Distrib::d(const glm::vec3 &N, const glm::vec3 &M)
{
    return Microfacet::gtr1(Math::absDot(N, M), alpha);
}

float GTR1Distrib::pdf(const glm::vec3 &N, const glm::vec3 &M, const glm::vec3 &Wo)
{
    return d(N, M) * Math::absDot(N, M);
}

glm::vec3 GTR1Distrib::sampleWm(const glm::vec3 &N, const glm::vec3 &Wo, const glm::vec2 &u)
{
